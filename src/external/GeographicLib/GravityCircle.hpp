...
private:
	...
	unsigned _caps;
	real _a, _f, _lat, _h, _zZ, _pPx, _invR, _cpsi, _spsi, _cphi, _sphi, _amodel, _gGMmodel, _dzonal0, _corrmult, _gamma0, _gamma,
	    _frot;
	CircularEngine _gravitational, _disturbing, _correction;

	GravityCircle(mask caps, real a, real f, real lat, real h, real Z, real P, real cphi, real sphi, real amodel, real GMmodel,
	              real dzonal0, real corrmult, real gamma0, real gamma, real frot, const CircularEngine &gravitational,
	              const CircularEngine &disturbing, const CircularEngine &correction);
...
public:
	 ...
	 *   (meters).
	 *
	 * Some approximations are made in computing the geoid height so that
	 *the results of the NGA codes are reproduced accurately.  Details are
	 ...
	 *is the value inherited from the GravityModel object used in the
	 *   constructor.
	 **********************************************************************/

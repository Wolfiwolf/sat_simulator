...
private:
	...
	real _a, _f;
	bool _exact;
	real _b, _c2, _f1, _salp0, _calp0, _k2, _salp1, _calp1, _ssig1, _csig1, _dn1, _stau1, _ctau1, _somg1, _comg1, _aA1m1, _aA2m1, _aA3c,
	    _bB11, _bB21, _bB31, _aA4, _bB41;
	real _a13, _s13;
...
public:
	...
	enum mask {
		 ...
		 *GeodesicLine::LATITUDE, GeodesicLine::LONGITUDE,
		 *GeodesicLine::AZIMUTH, GeodesicLine::DISTANCE.
		 * @hideinitializer
		 **********************************************************************/
		 ...
		 *(GeodesicLine::LONG_UNROLL is not included in this mask.)
		 * @hideinitializer
		 **********************************************************************/
		ALL = Geodesic::ALL,
	};
	 ...
	 *
	 * @param[in] g A Geodesic object used to compute the necessary
	 ...
	 * - \e caps |= GeodesicLine::REDUCEDLENGTH for the reduced length \e
	 *m12;
	 ...
	 * Use Init() to test whether object is still in this uninitialized
	 *state.
	 **********************************************************************/
	 ...
	 *the GeodesicLine object was constructed with \e caps |=
	 *   GeodesicLine::REDUCEDLENGTH.
	 * @param[out] M12 geodesic scale of point 2 relative to point 1
	 *   (dimensionless); requires that the GeodesicLine object was
	 *constructed with \e caps |= GeodesicLine::GEODESICSCALE.
	 ...
	 *is not capable of computing is not an error; the corresponding
	 *argument will not be altered.
	 *
	 * The following functions are overloaded versions of
	 * GeodesicLine::Position which omit some of the output parameters.
	 ...
	 *   parameter; if \e arcmode is false, then the GeodesicLine object
	 *must have been constructed with \e caps |= GeodesicLine::DISTANCE_IN.
	 ...
	 * @param[in] outmask a bitor'ed combination of GeodesicLine::mask
	 ...
	 * - \e outmask |= GeodesicLine::LONG_UNROLL to unroll \e lon2 instead
	 *of reducing it into the range [&minus;180&deg;, 180&deg;].
	 * .
	 * Requesting a value which the GeodesicLine object is not capable of
	 * computing is not an error; the corresponding argument will not be
	 ...
	 *is the value inherited from the Geodesic object used in the
	 *constructor.
	 **********************************************************************/

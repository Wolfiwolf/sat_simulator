...
private:
	...
	real Datanhee(real x, real y) const
	{
		...
		return t == 0 ? 1 / d : (x * y < 0 ? atanhee(x) - atanhee(y) : atanhee(t / d)) / t;
	}
...
public:
	 ...
	 * @param[in] stdlat standard parallel (degrees), the circle of
	 *tangency.
	...
	/**
	 * Constructor with two standard parallels specified by sines and
	 *cosines.
	 *
	 * @param[in] a equatorial radius of ellipsoid (meters).
	 * @param[in] f flattening of ellipsoid.  Setting \e f = 0 gives a
	 ...
	 *at this latitude.  If \e dlat = abs(\e lat2 &minus; \e lat1) &le;
	 *160&deg;, then the error in the latitude of origin is less than 4.5
	 *&times; 10<sup>&minus;14</sup>d;.
	 **********************************************************************/
	 ...
	 * points which project to infinity (i.e., one or both of the poles)
	 ...
	 *
	 * The latitude origin is given by AlbersEqualArea::LatitudeOrigin(). No
	 * false easting or northing is added.  The value of \e lon returned is
	 *in the range [&minus;180&deg;, 180&deg;].  The value of \e lat
	...
	/**
	 * @return \e f the flattening of the ellipsoid.  This is the value used
	 *in the constructor.
	 **********************************************************************/
	 ...
	 *
	 * This is the latitude of minimum azimuthal scale and equals the \e
	 *stdlat in the 1-parallel constructor and lies between \e stdlat1 and
	 *\e stdlat2 in the 2-parallel constructors.
	 **********************************************************************/
	...
	/**
	 * @return central scale for the projection.  This is the azimuthal
	 *scale on the latitude of origin.
	 **********************************************************************/
	 ...
	 *\e stdlat = 0, and \e k0 = 1.  This degenerates to the cylindrical
	...
	/**
	 * A global instantiation of AlbersEqualArea with the WGS84 ellipsoid,
	 *\e stdlat = 90&deg;, and \e k0 = 1.  This degenerates to the Lambert
	...
	/**
	 * A global instantiation of AlbersEqualArea with the WGS84 ellipsoid,
	 *\e stdlat = &minus;90&deg;, and \e k0 = 1.  This degenerates to the

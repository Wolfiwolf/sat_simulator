...
public:
	...
	template <typename T = real> static T WGS84_f()
	{
		...
		// round-off error by about 10%.  However, expressing the
		// flattening as 1/298.257223563 is well ingrained.
	 ...
	 * s<sup>&minus;1</sup>.  365.25 is the number of days in a Julian year
	 *and 365.35/366.25 converts from solar days to sidereal days.  Using
	 *the number of days in a Gregorian year (365.2425) results in a worse

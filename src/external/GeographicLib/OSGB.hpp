...
public:
	 ...
	 *   allocatied.
	 *
	 * \e prec specifies the precision of the grid reference string as
	 *follows:
	 * - prec = 0 (min), 100km
	 * - prec = 1, 10km
	 * - prec = 2, 1km
	 ...
	 * @param[in] centerp if true (default), return center of the grid
	 ...
	 *are set to NaN and \e prec is set to &minus;2.
	 **********************************************************************/
	...
	///@{
	/**
	 * @return \e a the equatorial radius of the Airy 1830 ellipsoid
	 *(meters).
	 *
	 ...
	 * because the OSGB projection is based on this ellipsoid.  The
	 *conversion factor from feet to meters is the one used for the 1936
	 *retriangulation of Britain; see Section A.1 (footnote 10 on p. 44) of
	 *<i>A guide to coordinate systems in Great Britain</i>, v3.6 (2020).
	 **********************************************************************/
	static Math::real EquatorialRadius()
	{
		// result is about 6377563.3960320664406 m
		using std::pow;
		return pow(real(10), real(48401603 - 100000000) / 100000000) * real(20923713);
	}
	 ...
	 *ft; thus the flattening = (20923713 &minus; 20853810)/20923713 =
	...
	/**
	 * @return \e k0 central scale for the OSGB projection
	 *(0.9996012717...).
	 *

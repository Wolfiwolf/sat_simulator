 ...
 *
 * <img
 *src="https://upload.wikimedia.org/wikipedia/commons/c/cb/Geodesic_problem_on_an_ellipsoid.svg"
 *width=250 alt="spheroidal triangle">
 *
...
private:
	...
	void Lengths(real eps, real sig12, real ssig1, real csig1, real dn1, real ssig2, real csig2, real dn2, real cbet1, real cbet2,
	             unsigned outmask, real &s12s, real &m12a, real &m0, real &M12, real &M21, real Ca[]) const;
	real InverseStart(real sbet1, real cbet1, real dn1, real sbet2, real cbet2, real dn2, real lam12, real slam12, real clam12,
	                  real &salp1, real &calp1, real &salp2, real &calp2, real &dnm, real Ca[]) const;
	real Lambda12(real sbet1, real cbet1, real dn1, real sbet2, real cbet2, real dn2, real salp1, real calp1, real slam120,
	              real clam120, real &salp2, real &calp2, real &sig12, real &ssig1, real &csig1, real &ssig2, real &csig2, real &eps,
	              real &domg12, bool diffp, real &dlam12, real Ca[]) const;
	...
	// These are Maxima generated functions to provide series approximations
	// to the integrals for the ellipsoidal geodesic.
...
public:
	 ...
	 * Geodesic::Line what capabilities should be included in the
	 *GeodesicLine object.  They also specify which results to return in the
	 *general routines Geodesic::GenDirect and Geodesic::GenInverse
	 *routines. GeodesicLine::mask is a duplication of this enum.
	 **********************************************************************/
	enum mask {
		/**
		 ...
		 *this as a capability to GeodesicLine because this is included
		 *by default.)
		 * @hideinitializer
		 **********************************************************************/
		 ...
		 *to include this as a capability to GeodesicLine because this
		 ...
		 *(Geodesic::LONG_UNROLL is not included in this mask.)
		 * @hideinitializer
		 **********************************************************************/
		ALL = OUT_ALL | CAP_ALL,
	};
	 ...
	 * which omit some of the output parameters.  Note, however, that the
	 *arc length is always computed and returned as the function value.
	 **********************************************************************/
	 ...
	 *this is automatically included is \e arcmode is false.
	 *
	 * With the Geodesic::LONG_UNROLL bit set, the quantity \e lon2 &minus;
	...
	///@{
	/**
	 * The general inverse geodesic calculation.  Geodesic::Inverse is
	...
	/**
	 * Define a GeodesicLine in terms of the direct geodesic problem

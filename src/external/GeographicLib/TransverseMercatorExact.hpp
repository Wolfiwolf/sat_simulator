...
private:
	...
	friend class TransverseMercator; // Allow TM to call the default
	                                 // constructor
	// Private default constructor to support TransverseMercator(a, f,
	// exact)
...
public:
	 ...
	 * false, the "standard" convention is followed, namely the cut is
	 placed
	 * along \e x > 18381 km, \e y = 0m.  Forward can be called with any \e
	 lat
	 * and \e lon then produces the transformation shown in Lee, Fig 46.
	 * Reverse analytically continues this in the &plusmn; \e x direction.
	 As
	 ...
	 * quadrant.  The various symmetries of the transverse Mercator
	 projection
	 ...
	 *   - \e lat in (-90, 0] and \e lon &minus; \e lon0 in [90 (1 &minus;
	 \e e), 90]
	 * - the union of
	 *   - <i>x</i>/(\e k0 \e a) in [0, &infin;) and
	 *     <i>y</i>/(\e k0 \e a) in [0, E(<i>e</i><sup>2</sup>)]
	 *   - <i>x</i>/(\e k0 \e a) in [K(1 &minus; <i>e</i><sup>2</sup>)
	 &minus;
	 *     E(1 &minus; <i>e</i><sup>2</sup>), &infin;) and <i>y</i>/(\e k0
	 \e
	 *     a) in (&minus;&infin;, 0]
	 * .
	 * See Sec. 5 of
	 * <a href="https://arxiv.org/abs/1002.1417">arXiv:1002.1417</a> for a
	 full
	 * discussion of the treatment of the branch cut.
	 *
	 * The method will work for all ellipsoids used in terrestrial geodesy.
	 * The method cannot be applied directly to the case of a sphere (\e f =
	 0)
	 ...
	 * numeric_limits<real>::epsilon().  However, TransverseMercator treats
	 the
	 * sphere exactly.
	 **********************************************************************/
	...
	/**
	 * TransverseMercatorExact::Forward without returning the convergence
	 *and scale.
	 **********************************************************************/
	...
	/**
	 * TransverseMercatorExact::Reverse without returning the convergence
	 *and scale.
	 **********************************************************************/
	...
	/**
	 * @return \e k0 central scale for the projection.  This is the value of
	 *\e k0 used in the constructor and is the scale on the central
	 *meridian.
	 **********************************************************************/

...
private:
	...
	real _a, _f, _b, _c2, _f1, _e2, _salp0, _calp0, _k2, _salp1, _calp1, _ssig1, _csig1, _dn1, _stau1, _ctau1, _somg1, _comg1, _cchi1,
	...
	GeodesicLineExact(const GeodesicExact &g, real lat1, real lon1, real azi1, real salp1, real calp1, unsigned caps, bool arcmode,
	                  real s13_a13);
...
public:
	...
	enum mask {
		 ...
		 *GeodesicLineExact::LATITUDE, GeodesicLineExact::LONGITUDE,
		 *GeodesicLineExact::AZIMUTH, GeodesicLineExact::DISTANCE.
		 * @hideinitializer
		 **********************************************************************/
	...
	/**
	 * Constructor for a geodesic line staring at latitude \e lat1,
	 *longitude \e lon1, and azimuth \e azi1 (all in degrees).
	 *
	 ...
	 * @param[in] caps bitor'ed combination of GeodesicLineExact::mask
	 *values specifying the capabilities the GeodesicLineExact object should
	 ...
	 * fixed, writing \e lat1 = &plusmn;(90&deg; &minus; &epsilon;), and
	 ...
	 * @param[out] m12 reduced length of geodesic (meters); requires that
	 *the GeodesicLineExact object was constructed with \e caps |=
	 ...
	 *requires that the GeodesicLineExact object was constructed with \e
	 *caps |= GeodesicLineExact::AREA.
	 * @return \e a12 arc length from point 1 to point 2 (degrees).
	 *
	 * The values of \e lon2 and \e azi2 returned are in the range
	 * [&minus;180&deg;, 180&deg;].
	 *
	 * The GeodesicLineExact object \e must have been constructed with \e
	 *caps
	 * |= GeodesicLineExact::DISTANCE_IN; otherwise Math::NaN() is returned
	 *and no parameters are set.  Requesting a value which the
	 *GeodesicLineExact object is not capable of computing is not an error;
	...
	{
		real t;
		return GenPosition(false, s12, LATITUDE | LONGITUDE | AZIMUTH | REDUCEDLENGTH | GEODESICSCALE | AREA, lat2, lon2, azi2, t,
		                   m12, M12, M21, S12);
	}
	...
	{
		real t;
		return GenPosition(false, s12, LATITUDE | LONGITUDE | AZIMUTH | REDUCEDLENGTH, lat2, lon2, azi2, t, m12, t, t, t);
	}
	...
	{
		real t;
		return GenPosition(false, s12, LATITUDE | LONGITUDE | AZIMUTH | REDUCEDLENGTH | GEODESICSCALE, lat2, lon2, azi2, t, m12,
		                   M12, M21, t);
	}
	///@}
	...
	/**
	 * Compute the position of point 2 which is an arc length \e a12
	 ...
	 *
	 * The following functions are overloaded versions of
	 * GeodesicLineExact::ArcPosition which omit some of the output
	 *parameters.
	 **********************************************************************/
	void ArcPosition(real a12, real &lat2, real &lon2, real &azi2, real &s12, real &m12, real &M12, real &M21, real &S12) const
	{
		GenPosition(true, a12, LATITUDE | LONGITUDE | AZIMUTH | DISTANCE | REDUCEDLENGTH | GEODESICSCALE | AREA, lat2, lon2, azi2,
		            s12, m12, M12, M21, S12);
	}
	...
	{
		real t;
		GenPosition(true, a12, LATITUDE | LONGITUDE | AZIMUTH | DISTANCE | REDUCEDLENGTH | GEODESICSCALE, lat2, lon2, azi2, s12,
		            m12, M12, M21, t);
	}
	///@}
	 ...
	 *   parameter; if \e arcmode is false, then the GeodesicLineExact
	 *object must have been constructed with \e caps |=
	 ...
	 * - \e outmask |= GeodesicLineExact::LONGITUDE for the latitude \e
	 *lon2;
	 * - \e outmask |= GeodesicLineExact::AZIMUTH for the latitude \e azi2;
	 * - \e outmask |= GeodesicLineExact::DISTANCE for the distance \e s12;
	 * - \e outmask |= GeodesicLineExact::REDUCEDLENGTH for the reduced
	 *length \e m12;
	 * - \e outmask |= GeodesicLineExact::GEODESICSCALE for the geodesic
	 ...
	 * - \e outmask |= GeodesicLineExact::LONG_UNROLL to unroll \e lon2
	 *instead of wrapping it into the range [&minus;180&deg;, 180&deg;].
	 * .
	 * Requesting a value which the GeodesicLineExact object is not capable
	 *of computing is not an error; the corresponding argument will not be
	 ...
	 **********************************************************************/
	Math::real GenPosition(bool arcmode, real s12_a12, unsigned outmask, real &lat2, real &lon2, real &azi2, real &s12, real &m12,
	 ...
	 *   can be negative.
	 *
	 * This is only useful if the GeodesicLineExact object has been
	 *constructed with \e caps |= GeodesicLineExact::DISTANCE_IN.
	 **********************************************************************/
	 ...
	 *   can be negative.
	 *
	 * The distance \e s13 is only set if the GeodesicLineExact object has
	 *been constructed with \e caps |= GeodesicLineExact::DISTANCE.
	 **********************************************************************/
	void SetArc(real a13);

	/**
	 * Specify position of point 3 in terms of either distance or arc
	 *length.
	 *
	 * @param[in] arcmode boolean flag determining the meaning of the second
	 *   parameter; if \e arcmode is false, then the GeodesicLineExact
	...
	/**
	 * @return \e azi1 the azimuth (degrees) of the geodesic line at
	 *point 1.
	 **********************************************************************/
	...
	/**
	 * @return \e azi0 the azimuth (degrees) of the geodesic line as it
	...
	/**
	 * @return \e a1 the arc length (degrees) between the northward
	 ...
	 *is the value inherited from the GeodesicExact object used in the
	 *   constructor.
	 **********************************************************************/
	 ...
	 * @return true if the GeodesicLineExact object has all these
	 *capabilities.
	 **********************************************************************/

...
public:
	 ...
	 * then set &alpha;<sup>2</sup> = 0 (the default value); in this case,
	 *we have &Pi;(&phi;, 0, \e k) = \e F(&phi;, \e k), \e G(&phi;, 0, \e k)
	 *= \e E(&phi;, \e k), and \e H(&phi;, 0, \e k) = \e F(&phi;, \e k) - \e
	 * D(&phi;, \e k).
	 **********************************************************************/
	...
	/**
	 * Constructor specifying the modulus and parameter and their
	 *complements.
	 *
	 * @param[in] k2 the square of the modulus <i>k</i><sup>2</sup>.
	 *   <i>k</i><sup>2</sup> must lie in (&minus;&infin;, 1].
	 * @param[in] alpha2 the parameter &alpha;<sup>2</sup>.
	 *   &alpha;<sup>2</sup> must lie in (&minus;&infin;, 1].
	 * @param[in] kp2 the complementary modulus squared
	 *<i>k'</i><sup>2</sup> = 1 &minus; <i>k</i><sup>2</sup>.  This must lie
	 *in [0, &infin;).
	 * @param[in] alphap2 the complementary parameter &alpha;'<sup>2</sup> =
	 *1 &minus; &alpha;<sup>2</sup>.  This must lie in [0, &infin;).
	 * @exception GeographicErr if \e k2, \e alpha2, \e kp2, or \e alphap2
	 *is out of its legal range.
	 *
	 * The arguments must satisfy \e k2 + \e kp2 = 1 and \e alpha2 + \e
	 *alphap2 = 1.  (No checking is done that these conditions are met.)
	 *This constructor is provided to enable accuracy to be maintained,
	 *e.g., when \e k is very close to unity.
	 **********************************************************************/
	 ...
	 *     \frac1{\sqrt{1-k^2\sin^2\theta}(1 -
	 *\alpha^2\sin^2\theta)}\,d\theta. \f]
	 **********************************************************************/
	 ...
	 *    &= \int_0^\phi
	 *     \frac{\sqrt{1-k^2\sin^2\theta}}{1 -
	 *\alpha^2\sin^2\theta}\,d\theta. \end{align} \f]
	 *
	 * Legendre expresses the longitude of a point on the geodesic in terms
	 *of this combination of elliptic integrals in Exercices de Calcul
	 ...
	 *in terms of this combination of elliptic integrals in Phil. Mag.
	 *<b>40</b> (1870), p. 333,
	 ...
	 *
	 * <i>R</i><sub><i>F</i></sub> is defined in
	 *https://dlmf.nist.gov/19.16.E1 \f[ R_F(x, y, z) = \frac12
	 *       \int_0^\infty\frac1{\sqrt{(t + x) (t + y) (t + z)}}\, dt, \f]
	 * where at most one of arguments, \e x, \e y, \e z, can be zero and
	 *those arguments that are nonzero must be positive.  If one of the
	 *arguments is zero, it is more efficient to call the two-argument
	 *version of this function with the non-zero arguments.
	 **********************************************************************/
	 ...
	 *
	 * <i>R</i><sub><i>C</i></sub> is defined in
	 *https://dlmf.nist.gov/19.2.E17 \f[ R_C(x, y) = \frac12
	 ...
	 *        \biggr)t\,dt, \f]
	 * where at most one of arguments, \e x, \e y, \e z, can be zero and
	 *those arguments that are nonzero must be positive.  See also
	 * https://dlmf.nist.gov/19.23.E6_5.  If one of the arguments is zero,
	 *it is more efficient to call the two-argument version of this function
	 *with the non-zero arguments.
	 **********************************************************************/
	 ...
	 *
	 * <i>R</i><sub><i>J</i></sub> is defined in
	 *https://dlmf.nist.gov/19.16.E2 \f[ R_J(x, y, z, p) = \frac32
	 *       \int_0^\infty
	 *       [(t + x) (t + y) (t + z)]^{-1/2} (t + p)^{-1}\, dt, \f]
	 * where \e p > 0, and \e x, \e y, \e z are nonnegative with at most one
	 *of them being 0.
	 **********************************************************************/
	 ...
	 *
	 * <i>R</i><sub><i>D</i></sub> is defined in
	 *https://dlmf.nist.gov/19.16.E5 \f[ R_D(x, y, z) = \frac32
	 *       \int_0^\infty[(t + x) (t + y)]^{-1/2} (t + z)^{-3/2}\, dt, \f]
	 * where \e x, \e y, \e z are positive except that at most one of \e x
	 *and \e y can be 0.
	 **********************************************************************/

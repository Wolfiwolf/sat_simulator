...
public:
	...
	/**
	 * @return a reference to the \e y component.  This allows this
	...
	/**
	 * @return a reference to the \e x component.  This allows this
	 *component to be altered.
	 **********************************************************************/
	Math::real &x()
	{
	...
	/**
	 * Normalize the AuxAngle in place so that the \e y and \e x components
	 *are equal to the sine and cosine of the angle.
	 **********************************************************************/
	void normalize()
	{
		*this = normalized();
	 ...
	 *
	 * @param[in] p the AuxAngle from which the quadrant information is
	 *taken.
	 ...
	 *
	 * This allows a new AuxAngle to be initialized as an angle in degrees
	 *with
	 * @code
	...
	/**
	 * Construct and return an AuxAngle specied by the lambertian of the
	 *angle.
	 *
	 * @param[in] psi the lambertian of the angle.
	 * @return the corresponding AuxAngle.
	 *
	 * This allows a new AuxAngle to be initialized given the lambertian
	 *with
	 * @code

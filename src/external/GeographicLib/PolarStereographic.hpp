...
public:
	 ...
	 *
	 * @param[in] northp the pole which is the center of projection (true
	 *means north, false means south).
	...
	/**
	 * PolarStereographic::Forward without returning the convergence and
	 *scale.
	 **********************************************************************/
	...
	/**
	 * PolarStereographic::Reverse without returning the convergence and
	 *scale.
	 **********************************************************************/
	...
	/**
	 * The central scale for the projection.  This is the value of \e k0
	 *used in the constructor and is the scale at the pole unless overridden
	 *by PolarStereographic::SetScale.
	 **********************************************************************/

 ...
 **********************************************************************/
#define GEOGRAPHICLIB_TRANSVERSEMERCATOR_ORDER (GEOGRAPHICLIB_PRECISION == 2 ? 6 : (GEOGRAPHICLIB_PRECISION == 1 ? 4 : 8))
#endif
...
public:
	 ...
	 * @param[in] extendp use extended domain (default false); should only
	 *be used if \e exact = true;
	 * @exception GeographicErr if \e a, (1 &minus; \e f) \e a, or \e k0 is
	 *   not positive.
	 *
	 * With \e exact = true, this class delegates the calculations to the
	 * TransverseMercatorExact classes which compute the projection in terms
	...
	/**
	 * TransverseMercator::Forward without returning the convergence and
	 *scale.
	 **********************************************************************/
	...
	/**
	 * TransverseMercator::Reverse without returning the convergence and
	 *scale.
	 **********************************************************************/

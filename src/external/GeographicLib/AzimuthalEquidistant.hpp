...
public:
	 ...
	 *1/\e rk in the direction perpendicular to this.  A call to Reverse
	 *followed by a call to Forward will return the original (\e x, \e y)
	 *(to roundoff) only if the geodesic to (\e x, \e y) is a shortest path.
	 **********************************************************************/
	void Reverse(real lat0, real lon0, real x, real y, real &lat, real &lon, real &azi, real &rk) const;

	/**
	 * AzimuthalEquidistant::Forward without returning the azimuth and
	 *scale.
	 **********************************************************************/
	...
	/**
	 * AzimuthalEquidistant::Reverse without returning the azimuth and
	 *scale.
	 **********************************************************************/
